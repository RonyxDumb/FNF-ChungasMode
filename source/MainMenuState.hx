...
class MainMenuState extends MusicBeatState
{
	...
	public static var kadeEngineVer:String = "0.0.1" + nightly;
	public static var gameVer:String = "0.0.1";
	...
	override function create()
	{
		...
		versionShit.setFormat("Bronx", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
